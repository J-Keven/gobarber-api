...
describe('CreateAppointmets', function () {
    ...
    it('should be able to list all appointments availability in a month', function () { return __awaiter(void 0, void 0, void 0, function () {
        var monthProvider;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 14:
                    monthProvider = _a.sent();
                    expect(monthProvider).toStrictEqual(expect.arrayContaining([
