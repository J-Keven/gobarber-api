...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, createUsersService, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password;
                        createUsersService = tsyringe_1.container.resolve(CreateUsersService_1.default);
                        return [4 /*yield*/, createUsersService.execute({ name: name, email: email, password: password })];
                    case 1:
                        user = _b.sent();
