...
var SessionsController = /** @class */ (function () {
    ...
    SessionsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, authtorizationUserService, _b, user, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        authtorizationUserService = tsyringe_1.container.resolve(AuthtorizationUserService_1.default);
                        return [4 /*yield*/, authtorizationUserService.execute({
                                email: email,
                                password: password,
                            })];
                    case 1:
