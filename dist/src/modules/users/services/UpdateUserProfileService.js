...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, userId = _a.userId, oldPassword = _a.oldPassword, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user, emailExist, checkOldPassword, _b;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !oldPassword) {
                            throw new AppError_1.default('You need inform the old passsord to set new password');
                        }
                        user.name = name;
                        user.email = email;
                        if (!(password && oldPassword)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.hashProvider.compare(oldPassword, user.password)];
                    case 3:
                        checkOldPassword = _c.sent();
                        if (!checkOldPassword) {
                            throw new AppError_1.default('the old password does not match');
                        }
                        _b = user;
