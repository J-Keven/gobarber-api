...
describe('CreateUser', function () {
    beforeEach(function () {
        ...
        createUserService = new CreateUsersService_1.default(userRepository, fakeHashPovider, fakeCacheProvider);
    });
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUserService.execute(userData)];
                case 1:
                    user = _a.sent();
    ...
    it('should not be albe create a new user with same the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUserService.execute(userData)];
                case 1:
                    _a.sent();
                    expect(createUserService.execute(userData)).rejects.toBeInstanceOf(AppError_1.default);
                    return [2 /*return*/];
            }
        });
    }); });
