                ...
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {
                            ...
                            from: {
                                name: (from === null || from === void 0 ? void 0 : from.name) || mail_1.default.default.from.name,
                                address: (from === null || from === void 0 ? void 0 : from.email) || mail_1.default.default.from.addrees,
                            },
                            subject: subject
                        };
